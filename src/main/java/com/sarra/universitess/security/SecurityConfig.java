...
public class SecurityConfig {
	...
	.requestMatchers("/showCreate","/saveUniversite")
	.hasAnyAuthority("ADMIN","AGENT")
	
	.requestMatchers("/modifierUniversite", "/supprimerUniversite")
	.hasAnyAuthority("ADMIN")

	.requestMatchers("/ListeUniversites")
